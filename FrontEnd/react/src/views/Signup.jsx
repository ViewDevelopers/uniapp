...
export default function Signup() {
  return (
    <>
      <h2 className="mt-6 text-center text-3xl font-regular tracking-tight text-gray-900">
      Registrate<span className="font-bold"> ¡es gratis!</span> 
      </h2>
      <p className="mt-6 text-center font-regular tracking-tight text-gray-900">
              Diligencia todos los campos a continuación.
      </p>
