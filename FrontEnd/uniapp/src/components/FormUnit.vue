            ...
            >
              <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                <div>
                  ...
                  >
                    <BuildingOffice2Icon class="h-6 w-6 text-blue" aria-hidden="true" />
                  </div>
                      ...
                      <form action="" class="w-full">
                        ...
                        <div class="mb-4">
                          ...
                          <input
                            id="unitAddress"
                            type="text"
                            placeholder="Direccion de la Unidad"
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 pl-3 focus:ring-2 focus:ring-inset focus:ring-indigo-100 sm:text-sm sm:leading-6"
                          />
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="flex justify-end">
                          ...
                          <button
                            type="button"
                            class="inline-flex justify-center px-4 py-2 ml-3 text-sm font-medium text-gray-700 bg-gray-200 border border-transparent rounded-md shadow-sm hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500" @click="open = false" ref="cancelButtonRef"
                          >
                            Cancelar
                          </button>
                        </div>
