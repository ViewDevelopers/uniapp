          ...
          <div>
            <div>
              ...
              <p className="mt-6 text-2xl leading-10 text-black max-w-5xl">
               Somos una aplicación diseñada por la empresa Solutions Dev, empresa especialista en soluciones tecnologicas a la medida de las necesidades de distintos mercados. Esta startup nació de 3 estudiantes y el profe "Edder" de confenalco Colombia.
              </p>
