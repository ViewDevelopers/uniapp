    ...
    <div className="bg-white">
      <div className="mx-auto lg:mx-12 max-w-full py-16 px-4 sm:px-6 lg:grid lg:grid-cols-3 lg:gap-x-8 lg:py-24 lg:px-8">
        <div>
          ...
          <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900">Todo en una sola plataforma</p>
          <p className="mt-4 text-lg text-gray-500">
            Nos enfocamos en mejorar tu experiencia, para que así mismo puedas llevar de una manera más efeciente el control de tus unidades residenciales.
          </p>
        </div>
