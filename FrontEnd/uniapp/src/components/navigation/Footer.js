...
import imagotipo from 'assets/img/imagotipo-aurapp.svg'
const navigation = {
    solutions: [
      { name: 'Marketing', href: '#' },
      { name: 'Analytics', href: '#' },
    ...
    return(
        ...
        <div className="mx-auto max-w-full py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          ...
          <div className="mt-12 border-t border-gray-200 pt-8">
            <p className="text-base text-gray-400 xl:text-center">&copy; 2023 Uniapp by Solutions Dev, Inc. All rights reserved.</p>
          </div>
        </div>
      </footer>
    )
